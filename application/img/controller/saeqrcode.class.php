...
class SaeQRcode
{
    ...
    public function build() 
    {
        ...
        $this->code = '/data/wwwroot/api.lwl12.com/application/runtime/cache/' . md5($this->data.$this->width.$this->height.$this->icon) . '.png';
        ...
        try {
            ...
            QRcodes::png($this->data, $this->code, $this->level, 3, $this->margin);
        } catch(Exception $e) {
            $this->errNum = -4;
